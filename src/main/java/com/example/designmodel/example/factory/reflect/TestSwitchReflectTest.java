package com.example.designmodel.example.factory.reflect;
 ...
 */
public class TestSwitchReflectTest {
    ...
    public static void testReflect(int code) throws ClassNotFoundException, NoSuchMethodException, InstantiationException, IllegalAccessException, InvocationTargetException {
        Class clz = Class.forName("com.example.designmodel.example.factory.reflect.BusinessMethod");
        //产生实例 简单的工厂方法模式，通过反射来创建对象
